...
const CreatePost = () => {
 ...
 const generateImage= async ()=>{
  ...
  if(form.prompt){
    try {
      ...
      const response = await fetch('https://dall-e-bvhf.onrender.com/api/v1/dalle',{   //'http://localhost:8080/api/v1/dalle'
        method: 'POST',
        headers: {
 ...
 const handleSubmit=async (e)=>{
  ...
  if(form.prompt && form.photo){
    ...
    try {
      const response = await fetch('https://dall-e-bvhf.onrender.com/api/v1/post',{
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
 ...
 const handleSurpriseMe=()=>{
  ...
  return (
    ...
    Once you have created the image u=you can share with others in community</p>
    <button type='submit'
